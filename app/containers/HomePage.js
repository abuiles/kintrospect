...
export default class HomePage extends Component {
  ...
  openDownloads(event) {
    ...
    shell.openExternal('https://kintrospect.com/downloads.html')
  }
      ...
      content = (
        <div className="vh-100 tc bg-blue">
          <div className="paragraph center mw-100 white pv4">
            ...
            <a className="f2 white" onClick={(e) => this.openDownloads(e) } href="https://kintrospect.com/downloads.html" target="_blank" rel="noopener noreferrer">https://kintrospect.com/downloads.html</a>
          </div>
        </div>
      )
    }
